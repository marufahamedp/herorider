...
function RegisterasaLearner() {
    ...
    const { user, registerUserb, isLoading, authError } = useAuth();
    const [vehicle, setVehicleType] = useState('');
    const [rider, setRider] = useState('Learner');
    ...
    const handleLoginSubmit = e => {
        ...
        registerUserb(loginData.email, loginData.password, loginData.name, licenceimage, nidfrontimage, nidbackimage, profileimage, loginData.age, loginData.address, loginData.number, loginData.area, loginData.carname, loginData.carmodel, loginData.carpalate, vehicle, rider, navigate);
        e.preventDefault();
    }
    console.log(rider);
...
export default RegisterasaLearner
